...
#define APP_TIMER_TICKS(MS) k_ms_to_ticks_floor32(MS)
...
static struct k_app_timer timer_id##_obj; \
static struct k_app_timer *timer_id = &timer_id##_obj

typedef struct k_app_timer app_timer_t;
