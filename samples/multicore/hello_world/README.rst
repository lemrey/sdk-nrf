...
You can use this sample to see how to build Hello World application for multicore SoC.
The sample adds remote image as a child image from the sample source files.
...
.. table-from-rows:: /includes/sample_board_rows.txt
   :header: heading
   :rows: nrf5340dk_nrf5340_cpuapp, nrf54fpga_nrf5420_cpuapp
