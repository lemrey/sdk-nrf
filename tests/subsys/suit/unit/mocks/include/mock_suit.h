...
FAKE_VALUE_FUNC(int, suit_process_sequence, uint8_t *, size_t, enum suit_command_sequence);
FAKE_VALUE_FUNC(int, suit_processor_get_manifest_metadata, uint8_t *, size_t, bool,
		struct zcbor_string *, struct zcbor_string *, unsigned int *);
