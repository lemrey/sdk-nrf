...
suit-tool create -i $1 -o sample.suit
suit-tool sign -m sample.suit -k key_private.pem -o sample_signed.suit
zcbor convert -c ../../../../../modules/lib/suit-processor/cddl/manifest.cddl -i ./sample_signed.suit --input-as cbor -t SUIT_Envelope_Tagged -o sample_signed.suit.c --c-code-var-name manifest --c-code-columns 8
