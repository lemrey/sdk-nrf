...
The application can use the following functions for different tracing activities:

* :c:func:`nrf_modem_lib_trace_level_set` - This function sets the trace level and resumes the trace session, if it is paused.
* :c:func:`nrf_modem_lib_trace_pause` - This function pauses the trace session.
* :c:func:`nrf_modem_lib_trace_resume` - This function resumes the trace session.
