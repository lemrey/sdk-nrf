...
12           Cell   RWS          SecDom <-> Cell IPC; Cell's Secure data
13           Cell   RW           Cell <-> App IPC; Cell's Non-Secure data
14           Cell   RXS          Cell's S-NSC; Cell's Secure code
15           Cell   RX           Cell's Non-Secure code
18           ISIM   RWX          ISIM's code and storage
29           App    RW           App's NV storage; DFU storage bank
30           Radio  RW           Radio's NV storage
===========  =====  ===========  ======================================================
...
5            Cell   RW(S)        Cell mngMbox; SysCtrl <-> Cell IPC
6            Cell   RW(S)        DMA buffers for Cell's fast peripherals (if any)
===========  =====  ===========  ==============================================================================
...
OVERRIDE Id  Owner  Permissions  Regions
===========  =====  ===========  ===========================================================================
1            App    RWX(S)       PPR code; PPR data; PPR <-> App IPC; DMA buffers for App's slow peripherals
3            Radio  RW(S)        DMA buffers for Radio's slow peripherals (if any)
6            Cell   RW(S)        DMA buffers for Cell's slow peripherals (if any)
===========  =====  ===========  ===========================================================================
