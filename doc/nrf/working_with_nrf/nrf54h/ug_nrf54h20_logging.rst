...
There are two suggested ways of reading logs on the nRF54H20 PDK:

* Using a direct UART connection
* Using System Trace Macrocell (STM)

For general information on how logging works in the |NCS|, consult the :ref:`ug_logging` documentation page.
...
nRF54H20 domains contain System Trace Macrocell (STM) hardware devices to multiplex the logs generated by the domains in the system.
The STM multiplexes the logs as traces protocol data and synchronizes them on a single output, such as a single UART.
