...
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_HAS_ACCEL_KEY_TYPES_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_HAS_AEAD_SUPPORT_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_HAS_ASYM_ENCRYPT_SUPPORT_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_HAS_ASYM_SIGN_SUPPORT_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_HAS_CIPHER_SUPPORT_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_HAS_ECC_SUPPORT_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_HAS_HASH_SUPPORT_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_HAS_KDF_SUPPORT_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_HAS_MAC_SUPPORT_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ALG_CBC_NO_PADDING_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ALG_CBC_PKCS7_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ALG_CCM_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ALG_CHACHA20_POLY1305_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ALG_CMAC_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ALG_CTR_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ALG_DETERMINISTIC_ECDSA_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ALG_ECB_NO_PADDING_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ALG_ECDH_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ALG_ECDSA_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ALG_GCM_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ALG_HKDF_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ALG_HMAC_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ALG_SHA_1_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ALG_SHA_224_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ALG_SHA_256_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ALG_SHA_384_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ALG_SHA_512_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ALG_STREAM_CIPHER_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ECC_MONTGOMERY_255_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ECC_SECP_R1_224_CRACEN)
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ECC_SECP_R1_256_CRACEN)
...
kconfig_check_and_set_base_to_one(PSA_CRYPTO_DRIVER_ALG_SRP_CRACEN)
