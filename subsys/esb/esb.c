...
static void setup_4mbit_regs(void)
{
	NRF_RADIO->CHANNELFILTERS.IIR0.COEFFSB0 =   128;
	NRF_RADIO->CHANNELFILTERS.IIR0.COEFFSB1 =   128;
	NRF_RADIO->CHANNELFILTERS.IIR0.COEFFSB2 =     0;
	NRF_RADIO->CHANNELFILTERS.IIR0.COEFFSA1 =  -768;
	NRF_RADIO->CHANNELFILTERS.IIR0.COEFFSA2 =     0;
	NRF_RADIO->CHANNELFILTERS.IIR1.COEFFSB0 =    96;
	NRF_RADIO->CHANNELFILTERS.IIR1.COEFFSB1 =    96;
	NRF_RADIO->CHANNELFILTERS.IIR1.COEFFSB2 =    96;
	NRF_RADIO->CHANNELFILTERS.IIR1.COEFFSA1 = -1536;
	NRF_RADIO->CHANNELFILTERS.IIR1.COEFFSA2 =   768;
	NRF_RADIO->CHANNELFILTERS.NOTCHIIR0.COEFFSB0 =   960;
	NRF_RADIO->CHANNELFILTERS.NOTCHIIR0.COEFFSB1 = -1360;
	NRF_RADIO->CHANNELFILTERS.NOTCHIIR0.COEFFSB2 =   960;
	NRF_RADIO->CHANNELFILTERS.NOTCHIIR0.COEFFSA1 = -1360;
	NRF_RADIO->CHANNELFILTERS.NOTCHIIR0.COEFFSA2 =   896;
	NRF_RADIO->MODECONF = 0x00010008;
	NRF_RADIO->SPHYNXANA.MODEDEPENDENT = 2;
	NRF_RADIO->IFFREQ = 3;
}
