 ...
 * 8) The public functions of a module must convert all of the error codes coming from its dependencies
 *    either to errors from its own error code pool or to errors from the common platform error pool.
